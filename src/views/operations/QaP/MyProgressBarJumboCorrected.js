...
const MyProgressBarJumbo = ({containerWidth, progressBarId,jumboId }) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response = await fetch(`https://factory.teamasia.in/api/public/faultlogs/?jumbo_roll_id=${jumboId}&is_small_roll_exist=1`, {
        method: 'GET', 
        headers: {
  ...
  return (
       ...
       <div style={{padding:'10px'}}>  
                     ...
                     {/* <ProgressBar  now={220} label={`${170}m`} className='progress_bar_color1' variant="info"/> */}
                       <div className="progress-bar-container-modal-correct"> {/* Fixed visual width */}
                        ...
                        {maxEnd < containerWidth && (
                          <div
                            ...
                            style={{
                              ...
                              backgroundColor: '#93e356', // Base color of the container
                              position: 'absolute',
