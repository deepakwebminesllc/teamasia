...
const Edit = () => {
  ...
  const {id,name:Name,hsn_code: hsnCode,is_trashed:isTrashed} = location.state || {};  // Default to an empty object if state is undefined
  ...
  async function apiCall() {
    try {
        ...
        const response = await fetch(`https://factory.teamasia.in/api/public/hsns/${id}`, {
            method: "PUT",
            headers: {
