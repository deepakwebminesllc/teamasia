...
const ProductBackSideAdd = ({refproductidforParent,FrontSubmitBlock, frontSidedata,data1, data3, data4, data5, data6, data7, data8 }) => {
...
console.log('refproductidforParent',refproductidforParent,frontSidedata);
